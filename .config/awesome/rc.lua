...
globalkeys = mytable.join(
    ...
    awful.key({modkey}, "-", function () os.execute("pamixer -i 5") end),
    awful.key({modkey}, "/", function () os.execute("pamixer -d 5") end),
    ...
    awful.key({ modkey }, "o", function () awful.spawn("discord --enable-gpu-rasterization --multi-instance") end,
              {description = "run discord", group = "launcher"}),
    awful.key({ modkey }, "e", function () awful.spawn("thunar") end,
              {description = "run filebrowser", group = "launcher"}),
    awful.key({ modkey }, ";", function () awful.spawn("proton-mail") end,
              {description = "run mailclient", group = "launcher"}),
    awful.key({ modkey }, "j", function () awful.spawn("obsidian") end,
    ...
    awful.key({ modkey }, "x", function () awful.spawn("remmina") end,
...
awful.rules.rules = {
    ...
    -- Set programs to always map to a specific tag on a specific screen.
    { rule_any = { 
        class = {
          "discord",
          "TelegramDesktop"
